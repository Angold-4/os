    ...
    800001e6:	00c587b3          	add	a5,a1,a2
{
    ...
    800001f4:	fed70fa3          	sb	a3,-1(a4) # ffffffffffffefff <end+0xffffffff7ffd8dbf>
    while(n-- > 0)
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003b54:	c00c0c1b          	addiw	s8,s8,-1024
...
loadseg(pagetable_t pagetable, uint64 va, struct inode *ip, uint offset, uint sz)
{
  ...
  ustack[argc] = 0;
    ...
    8000418e:	f9078793          	addi	a5,a5,-112 # f90 <_entry-0x7ffff070>
    ...
    8000532c:	f8040a13          	addi	s4,s0,-128
{
  ...
  disk.desc[idx[1]].flags |= VRING_DESC_F_NEXT;
    ...
    80005358:	00c65583          	lhu	a1,12(a2) # 200c <_entry-0x7fffdff4>
